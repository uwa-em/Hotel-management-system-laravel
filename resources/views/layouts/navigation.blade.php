                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        @else
                            ...
                            <x-nav-link :href="route('user.my-bookings')" :active="request()->routeIs('user.my-bookings')">
                                {{ __('My Bookings') }}
                            </x-nav-link>
                        @endif
                    @else
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                @else
                    ...
                    <x-responsive-nav-link :href="route('user.my-bookings')" :active="request()->routeIs('user.my-bookings')">
                        {{ __('My Bookings') }}
                    </x-responsive-nav-link>
                @endif
            @else
